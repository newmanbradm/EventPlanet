...
Created with a Ruby on Rails API backend and a React frontend with Redux, EventPlanet is an event coordinator's dream application, serivng as a "one-stop-shop" organizer for events of all styles and sizes. Input and update your events' details, upload photos and information for your venues, keep track of guest or volunteer contact information, and monitor purchased supplies and remaining budgets. You can even start unique inspiration boards for each event! Start planning your events with EventPlanet and you'll wonder how you ever coordinated events without it!
...
1. Fork it (<https://github.com/newmanbradm/EventPlanet>)
